class Tooltip extends HTMLElement {
	...
	constructor() {
		...
		this.shadowRoot.innerHTML = `
			<style>
				...
				:host(.important) { background: var(--color-primary, #ccc); padding: 0.15rem; }
				:host-context(p) { font-weight: bold; }
				::slotted(.highlight) { border-bottom: 1px dotted red; }
	...
	// list all your attributes you wish the component to observe
